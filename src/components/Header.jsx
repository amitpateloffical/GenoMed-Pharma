        ...
        <div className="px-5">
          <nav className="navbar navbar-expand-lg navbar-dark p-0 py-5">
            <Link to="/" className="navbar-brand a-index">
              <img className="" style={{ height: "140px", width: "140px", paddingTop: "20px"}} src="GenoLogo-removebg-preview.png" alt="Life Link Digital" />
            </Link>
            <Link to="/" >
              <div style={{ color: "#004526" }} className="logo123">GENOMED Pharmaceuticals</div>
            </Link>
            <button
              type="button"
